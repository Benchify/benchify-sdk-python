...
- <code title="post /v1/stacks/bundle-multipart">client.stacks.<a href="./src/benchify/resources/stacks.py">bundle_multipart</a>(\*\*<a href="src/benchify/types/stack_bundle_multipart_params.py">params</a>) -> <a href="./src/benchify/types/stack_bundle_multipart_response.py">StackBundleMultipartResponse</a></code>
